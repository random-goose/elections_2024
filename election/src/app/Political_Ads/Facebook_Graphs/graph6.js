...
export default function Graph6() {
	...
	const [urlGraph6, setUrlGraph6] = useState("");
	...
	const handleGenerateGraph6 = async () => {
		const requestData = {
		...
		try {
			const queryParamsGraph6 = new URLSearchParams(requestData).toString();
			setUrlGraph6(`http://localhost:5100/graph6?${queryParamsGraph6}`);
		} catch (error) {
			...
			<div className="container mt-4">
				<div className="card shadow-sm">
					<div className="card-body">
						<div className="mb-4">
							<h5>Advetising Data for Ages From Parties</h5>
							<div className="row g-3 mb-4">
								<div className="col-md-3">
									<div className="form-group">
										<label htmlFor="start-date-graph6" className="form-label fw-bold">
											Start Date:
										</label>
										<input
											type="date"
											className="form-control"
											id="start-date-graph6"
											value={startDate}
								...
								<div className="col-md-3">
									<div className="form-group">
										<label htmlFor="end-date-graph6" className="form-label fw-bold">
											End Date:
										</label>
										<input
											type="date"
								...
								<div className="col-md-3">
									<div className="form-group">
										<label htmlFor="column-select-graph6" className="form-label fw-bold">
											Select Data Column:
										</label>
										<select
											className="form-select"
											id="column-select-graph6"
								...
								<div className="col-md-3">
									<div className="form-group">
										<label htmlFor="party-select-graph6" className="form-label fw-bold">
											Select Parties:
										</label>
										<select
											multiple
											className="form-select"
											id="party-select-graph6"
											value={partyList}
